...
df<- cbind(astudies, data.frame(numcountry=v, countrycohort=v, wastprev=v, numsubj=v, numobs=v, median_length_between_measures=v, firstage=v, lastage=v, sd_obs=v, minages=v, maxages=v, mortality=v, birthweek=v, RCT=v, diar=v,
                                ...
                                meanWHZ_m1=v, meanWHZ_m2=v, meanWHZ_m3=v, meanWHZ_m4=v, meanWHZ_m5=v, meanWHZ_m6=v, meanWHZ_m7=v, meanWHZ_m8=v,
...
for(i in 1:nrow(df)){
  ...
  meanWHZ_m1<- meanWHZ_m2<- meanWHZ_m3<- meanWHZ_m4<- meanWHZ_m5<- meanWHZ_m6<- meanWHZ_m7<- meanWHZ_m8<-NA
  ...
  res<-t(c(numcountry, countrycohort, wastprev, numsubj, numobs, median_length_between_measures, firstage, lastage, sd_obs, minages, maxages, mortality, birthweek, RCT, diar, 
           ...
           meanWHZ_m1, meanWHZ_m2, meanWHZ_m3, meanWHZ_m4, meanWHZ_m5, meanWHZ_m6, meanWHZ_m7, meanWHZ_m8,
