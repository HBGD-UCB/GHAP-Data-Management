...
save(gmsn_inc, gmsn_inc_table, file="WastIncDatasets/gmsn_inc_NoBirthInc.Rdata")

d<-readRDS("zmrt.rds")
zmrt_inc<-WastIncCalc(d, dropBornWasted=T)
zmrt_inc_table <- WastIncTable(zmrt_inc)
save(zmrt_inc, zmrt_inc_table, file="WastIncDatasets/zmrt_inc_NoBirthInc.Rdata")
...
save(cntt_inc, cntt_inc_table, file="WastIncDatasets/cntt_inc_NoBirthInc.Rdata")


d<-readRDS("gbsc.rds")
dim(d)
d <- d %>% filter(!is.na(AGEDAYS))
dim(d)
gbsc_inc<-WastIncCalc(d, dropBornWasted=T)
gbsc_inc_table <- WastIncTable(gbsc_inc)
save(gbsc_inc, gbsc_inc_table, file="WastIncDatasets/gbsc_inc_NoBirthInc.Rdata")
...
save(cmin_inc_peru, 
     ...
     file="WastIncDatasets/cmin_inc_NoBirthInc.Rdata")


d<-readRDS("phua.rds")
phua_inc<-WastIncCalc(d, dropBornWasted=T)
phua_inc_table <- WastIncTable(phua_inc)
save(phua_inc, phua_inc_table, file="WastIncDatasets/phua_inc_NoBirthInc.Rdata")


d<-readRDS("tzc2.rds")
tzc2_inc<-WastIncCalc(d, dropBornWasted=T)
tzc2_inc_table <- WastIncTable(tzc2_inc)
save(tzc2_inc, tzc2_inc_table, file="WastIncDatasets/tzc2_inc_NoBirthInc.Rdata")


d<-readRDS("cmc.rds") 
cmc_inc<-WastIncCalc(d, dropBornWasted=T)
cmc_inc_table <- WastIncTable(cmc_inc)
save(cmc_inc, cmc_inc_table, file="WastIncDatasets/cmc_inc_NoBirthInc.Rdata")


d<-readRDS("ee.rds")  
ee_inc<-WastIncCalc(d, dropBornWasted=T)
ee_inc_table <- WastIncTable(ee_inc)
save(ee_inc, ee_inc_table, file="WastIncDatasets/ee_inc_NoBirthInc.Rdata")


d<-readRDS("irc.rds") 
irc_inc<-WastIncCalc(d, dropBornWasted=T)
irc_inc_table <- WastIncTable(irc_inc)
save(irc_inc, irc_inc_table, file="WastIncDatasets/irc_inc_NoBirthInc.Rdata")


d<-readRDS("tdc.rds")
tdc_inc<-WastIncCalc(d, dropBornWasted=T)
tdc_inc_table <- WastIncTable(tdc_inc)
save(tdc_inc, tdc_inc_table, file="WastIncDatasets/tdc_inc_NoBirthInc.Rdata")


d<-readRDS("rspk.rds")
rspk_inc<-WastIncCalc(d, dropBornWasted=T)
rspk_inc_table <- WastIncTable(rspk_inc)
save(rspk_inc, rspk_inc_table, file="WastIncDatasets/rspk_inc_NoBirthInc.Rdata")
...
save(mled_inc_bangladesh,
     ...
     file="WastIncDatasets/mled_inc_NoBirthInc.Rdata")
gc()
...
save(knba_inc, knba_inc_table, file="WastIncDatasets/knba_inc_NoBirthInc.Rdata")
...
save(prvd_inc, prvd_inc_table, file="WastIncDatasets/prvd_inc_NoBirthInc.Rdata")
...
save(cmpf_inc, cmpf_inc_table, file="WastIncDatasets/cmpf_inc_NoBirthInc.Rdata")

d<-readRDS("fspp.rds")
table(d$COUNTRY)
fspp_inc<-WastIncCalc(d, dropBornWasted=T)
fspp_inc_table <- WastIncTable(fspp_inc)
save(fspp_inc, fspp_inc_table, file="WastIncDatasets/fspp_inc_NoBirthInc.Rdata")
...
save(zvit_inc, zvit_inc_table, file="WastIncDatasets/zvit_inc_NoBirthInc.Rdata")

d<-readRDS("lnsz.rds")
table(d$COUNTRY)
lnsz_inc<-WastIncCalc(d, dropBornWasted=T)
lnsz_inc_table <- WastIncTable(lnsz_inc)
save(lnsz_inc, lnsz_inc_table, file="WastIncDatasets/lnsz_inc_NoBirthInc.Rdata")
...
save(akup_inc, akup_inc_table, file="WastIncDatasets/akup_inc_NoBirthInc.Rdata")

d<-readRDS("bfzn.rds")
table(d$COUNTRY)
bfzn_inc<-WastIncCalc(d, dropBornWasted=T)
bfzn_inc_table <- WastIncTable(bfzn_inc)
save(bfzn_inc, bfzn_inc_table, file="WastIncDatasets/bfzn_inc_NoBirthInc.Rdata")
gc()
...
save(gsto_inc, gsto_inc_table, file="WastIncDatasets/gsto_inc_NoBirthInc.Rdata")
gc()
...
save(jvt3_inc, jvt3_inc_table, file="WastIncDatasets/jvt3_inc_NoBirthInc.Rdata")
gc()
...
save(jvt4_inc, jvt4_inc_table, file="WastIncDatasets/jvt4_inc_NoBirthInc.Rdata")
gc()
...
save(lcn5_inc, lcn5_inc_table, file="WastIncDatasets/lcn5_inc_NoBirthInc.Rdata")

d<-readRDS("nbrt.rds")
table(d$COUNTRY)
nbrt_inc<-WastIncCalc(d, dropBornWasted=T)
nbrt_inc_table <- WastIncTable(nbrt_inc)
save(nbrt_inc, nbrt_inc_table, file="WastIncDatasets/nbrt_inc_NoBirthInc.Rdata")


d<-readRDS("prbt.rds")
prbt_inc<-WastIncCalc(d, dropBornWasted=T)
prbt_inc_table <- WastIncTable(prbt_inc)
save(prbt_inc, prbt_inc_table, file="WastIncDatasets/prbt_inc_NoBirthInc.Rdata")
gc()
...
save(cort_inc_brazil, 
     ...
     file="WastIncDatasets/cort_inc_NoBirthInc.Rdata")
gc()
...
save(ncry_inc, ncry_inc_table, file="WastIncDatasets/ncry_inc_NoBirthInc.Rdata")
...
save(incp_inc, incp_inc_table, file="WastIncDatasets/incp_inc_NoBirthInc.Rdata")

d<-readRDS("eczn.rds")
table(d$COUNTRY)
eczn_inc<-WastIncCalc(d, dropBornWasted=T)
eczn_inc_table <- WastIncTable(eczn_inc)
save(eczn_inc, eczn_inc_table, file="WastIncDatasets/eczn_inc_NoBirthInc.Rdata")
...
save(wsb_inc, wsb_inc_table, file="WastIncDatasets/wsb_inc_NoBirthInc.Rdata")

d<-readRDS("wsk.rds")
table(d$COUNTRY)
wsk_inc<-WastIncCalc(d, dropBornWasted=T)
wsk_inc_table <- WastIncTable(wsk_inc)
save(wsk_inc, wsk_inc_table, file="WastIncDatasets/wsk_inc_NoBirthInc.Rdata")

d<-readRDS("ilnd.rds")
table(d$COUNTRY)
ilnd_inc<-WastIncCalc(d, dropBornWasted=T)
ilnd_inc_table <- WastIncTable(ilnd_inc)
save(ilnd_inc, ilnd_inc_table, file="WastIncDatasets/ilnd_inc_NoBirthInc.Rdata")

d<-readRDS("ildm.rds")
table(d$COUNTRY)
ildm_inc<-WastIncCalc(d, dropBornWasted=T)
ildm_inc_table <- WastIncTable(ildm_inc)
save(ildm_inc, ildm_inc_table, file="WastIncDatasets/ildm_inc_NoBirthInc.Rdata")
